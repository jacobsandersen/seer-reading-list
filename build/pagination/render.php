...
$state = seer_reading_list_get_pagination();
...
<nav <?php echo $wrapper; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- get_block_wrapper_attributes() escapes. ?>>
	<?php echo seer_reading_list_render_pagination( $page, $total, $page_arg ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- rendered markup. ?>
</nav>
