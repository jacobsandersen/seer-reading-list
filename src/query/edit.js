...
export default function Edit( props ) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={ __( 'Seer Query Settings', 'seer-reading-list' ) }
				>
					<SelectControl
						label={ __( 'Seer Component', 'seer-reading-list' ) }
						value={ component }
						options={ COMPONENTS }
						onChange={ ( value ) =>
					...
					/>
					<RangeControl
						label={ __( 'Books to show', 'seer-reading-list' ) }
						value={ limit }
						min={ 1 }
						max={ 50 }
						onChange={ ( value ) =>
					...
					/>
					<RangeControl
						label={ __( 'Columns', 'seer-reading-list' ) }
						help={ __(
